...
#grid(
  ...
  card[
    ...
    #text(fill: text-body)[
      ...
      keeps budgets accurate, while on-site supervision keeps quality high and
      timelines on track.
    ]
  ],
)
...
#grid(
  ...
  card[#text(fill: gold, weight: "bold")[Transparent costing.] #text(fill: text-body)[ Detailed BOQs and accurate estimates, no surprises.]],
